...
// Which script to server static content from
var fdir = flag.String("dir", "./static/", "what script to run static file server from, if empty static files are not served")

// The name of the homepage in the specified script fdir, only matters if fdir is not ""
